    ...
    <div className="max-w-6xl px-4 py-12 mx-auto">
      ...
      <section id="end-of-lease" className="mb-12">
        ...
        <p className="text-gray-600">
          Complete cleaning for rental properties before moving out.
        </p>
        <Table className=" mt-6">
          <TableHeader>
            <TableRow className="bg-gray-300">
              <TableHead className="border p-2 text-black font-bold">
                Services
              </TableHead>
              <TableHead className="border p-2 text-black font-bold">
                Prices
      ...
      <Card className="mb-12">
        <CardHeader>
          <CardTitle>End of Lease Cleaning includes</CardTitle>
        </CardHeader>
        <CardContent>
          <ul className="list-disc ml-6  text-gray-900">
            <li className="p-2 rounded-lg">Vacuuming</li>
            <li className="p-2">Moping</li>
            <li className="p-2">Dusting</li>
            <li className="p-2">Cobweb removal</li>
            <li className="p-2">Mould removal</li>
            <li className="p-2">Grease from kitchen area</li>
            <li className="p-2">Range hood</li>
            ...
            <CardContent className="p-4 flex items-end gap-5">
              ...
              <ul className="list-disc ml-6 space-y-1">
                <li className="text-sm text-gray-700">
                  Price negotiable if any of the included cleaning not necessary
                </li>
                <li className="text-sm text-gray-700 mt-1">
                  Packages for all additional cleaning included from($150-$300)
                </li>
                <li>
                  <p className="text-sm text-gray-700 mt-1">
                    For exact quotes, please contact us at{" "}
                    <a
                      href="tel:+61403838360"
      ...
      <section
        id="other-cleaning-services"
        className="mb-12 px-6 py-3 bg-gray-100 border-2 border-gray-500 rounded-4xl"
      >
        ...
        <ul className="list-disc ml-6 space-y-1 text-gray-700">
          ...
          <p className="mt-4 flex items-center gap-3">
            For prices, call us at{" "}
            <Link href="tel:+61403838360">
              {" "}
              <Button>
                {" "}
                <FaPhoneAlt className="text-white size-6" />{" "}
                <strong>+61 403 838 360</strong>{" "}
              </Button>{" "}
            </Link>
          </p>
        </ul>
          ...
          {[
            {
              ...
              description: "Safe and affordable moving across Australia.",
            },
            {
              title: "Moving within Sydney",
              description: "Fast and reliable moving within Sydney.",
            },
